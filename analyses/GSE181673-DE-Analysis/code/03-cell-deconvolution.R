...
analysis_dir <- file.path(root_dir, "analyses", "GSE188673-DE-analysis")
...
mrna_data_file <- file.path(data_dir, "GSE181673_counts.csv")
...
mrna_expression_df <- readr::read_csv(mrna_data_file) #%>% 
